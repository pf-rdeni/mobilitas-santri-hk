    ...
    <div class="col-md-7">
        <div class="card card-outline card-primary shadow-sm">
            <div class="card-header bg-white border-bottom-0 pt-3 pb-0">
                <h3 class="card-title font-weight-bold text-dark"><i class="fas fa-user-edit mr-2 text-primary"></i> <?= $title ?></h3>
            </div>
            <form action="<?= base_url('panitia-manage/update/' . $user->id) ?>" method="post">
                <?= csrf_field() ?>
                <div class="card-body">
                    ...
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Perbarui data akun panitia melalui form di bawah.</p>
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="fullname" id="fullname" class="form-control <?= session('errors.fullname') ? 'is-invalid' : '' ?>" value="<?= old('fullname', $user->fullname) ?>" placeholder="Sesuai KTP/KK" required>
                    ...
                    <hr class="my-4">
                    <hr class="my-4">
                    <h6 class="text-muted font-weight-bold mb-3"><i class="fas fa-key mr-1 text-primary"></i> Atur Password Baru (Opsional)</h6>

                    <div class="form-group mb-3">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="useDefaultPassword">
                            <label class="custom-control-label text-info" style="cursor: pointer;" for="useDefaultPassword">
                                Ganti dengan password default: <strong>passwordpanitia123</strong>
                            </label>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="password" id="password" class="form-control <?= session('errors.password') ? 'is-invalid' : '' ?>" placeholder="Minimal 8 karakter" autocomplete="new-password">
                ...
                <div class="card-footer bg-light text-right border-top-0">
                    ...
                    <button type="submit" class="btn btn-primary px-4 shadow-sm font-weight-bold"><i class="fas fa-save mr-1"></i> Perbarui Akun Panitia</button>
                </div>
            </form>
        </div>
    </div>
